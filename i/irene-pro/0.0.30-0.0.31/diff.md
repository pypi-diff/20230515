# Comparing `tmp/irene_pro-0.0.30.tar.gz` & `tmp/irene_pro-0.0.31.tar.gz`
...
## Comparing `irene_pro-0.0.30.tar` & `irene_pro-0.0.31.tar`
...
### Comparing `irene_pro-0.0.30/PKG-INFO` & `irene_pro-0.0.31/PKG-INFO`
...
### Comparing `irene_pro-0.0.30/README.md` & `irene_pro-0.0.31/README.md`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.30/irene_pro/logic.py` & `irene_pro-0.0.31/irene_pro/logic.py`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.30/irene_pro/widgets.py` & `irene_pro-0.0.31/irene_pro/widgets.py`
...
### Comparing `irene_pro-0.0.30/irene_pro.egg-info/PKG-INFO` & `irene_pro-0.0.31/irene_pro.egg-info/PKG-INFO`
...
### Comparing `irene_pro-0.0.30/setup.py` & `irene_pro-0.0.31/setup.py`
