# Comparing `tmp/ptcompletion-0.1.2.tar.gz` & `tmp/ptcompletion-0.2.0.tar.gz`
...
+gzip compressed data, was "ptcompletion-0.2.0.tar", last modified: Mon May 15 06:22:14 2023, max compression
```

## Comparing `ptcompletion-0.1.2.tar` & `ptcompletion-0.2.0.tar`
...
+drwxrwxr-x   0 phantivia  (1000) phantivia  (1000)        0 2023-05-15 06:22:14.953489 ptcompletion-0.2.0/
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)     1066 2023-05-15 02:14:58.000000 ptcompletion-0.2.0/LICENSE
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)      791 2023-05-15 06:22:14.949489 ptcompletion-0.2.0/PKG-INFO
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)      281 2023-05-15 02:14:58.000000 ptcompletion-0.2.0/README.md
+drwxrwxr-x   0 phantivia  (1000) phantivia  (1000)        0 2023-05-15 06:22:14.949489 ptcompletion-0.2.0/ptcompletion/
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)       92 2023-05-14 11:59:06.000000 ptcompletion-0.2.0/ptcompletion/__init__.py
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)     1176 2023-05-15 02:04:34.000000 ptcompletion-0.2.0/ptcompletion/openai_task.py
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)     1632 2023-05-15 02:01:27.000000 ptcompletion-0.2.0/ptcompletion/task.py
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)     4163 2023-05-15 06:20:48.000000 ptcompletion-0.2.0/ptcompletion/task_queue.py
+drwxrwxr-x   0 phantivia  (1000) phantivia  (1000)        0 2023-05-15 06:22:14.949489 ptcompletion-0.2.0/ptcompletion.egg-info/
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)      791 2023-05-15 06:22:14.000000 ptcompletion-0.2.0/ptcompletion.egg-info/PKG-INFO
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)      306 2023-05-15 06:22:14.000000 ptcompletion-0.2.0/ptcompletion.egg-info/SOURCES.txt
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)        1 2023-05-15 06:22:14.000000 ptcompletion-0.2.0/ptcompletion.egg-info/dependency_links.txt
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)        7 2023-05-15 06:22:14.000000 ptcompletion-0.2.0/ptcompletion.egg-info/requires.txt
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)       13 2023-05-15 06:22:14.000000 ptcompletion-0.2.0/ptcompletion.egg-info/top_level.txt
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)       38 2023-05-15 06:22:14.953489 ptcompletion-0.2.0/setup.cfg
+-rw-rw-r--   0 phantivia  (1000) phantivia  (1000)      841 2023-05-15 06:22:11.000000 ptcompletion-0.2.0/setup.py
```

### Comparing `ptcompletion-0.1.2/LICENSE` & `ptcompletion-0.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `ptcompletion-0.1.2/PKG-INFO` & `ptcompletion-0.2.0/PKG-INFO`
...
### Comparing `ptcompletion-0.1.2/ptcompletion/openai_task.py` & `ptcompletion-0.2.0/ptcompletion/openai_task.py`

 * *Files identical despite different names*

### Comparing `ptcompletion-0.1.2/ptcompletion/task.py` & `ptcompletion-0.2.0/ptcompletion/task.py`

 * *Files identical despite different names*

### Comparing `ptcompletion-0.1.2/ptcompletion/task_queue.py` & `ptcompletion-0.2.0/ptcompletion/task_queue.py`
...
### Comparing `ptcompletion-0.1.2/ptcompletion.egg-info/PKG-INFO` & `ptcompletion-0.2.0/ptcompletion.egg-info/PKG-INFO`
...
### Comparing `ptcompletion-0.1.2/setup.py` & `ptcompletion-0.2.0/setup.py`
