# Comparing `tmp/py3d-0.0.87.tar.gz` & `tmp/py3d-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "py3d-0.0.87.tar", last modified: Mon May 15 14:09:37 2023, max compression
+gzip compressed data, was "dist/py3d-0.0.9.tar", last modified: Wed Nov  3 12:56:47 2021, max compression
```

## Comparing `py3d-0.0.87.tar` & `py3d-0.0.9.tar`

### file list

```diff
@@ -1,15 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-05-15 14:09:37.648146 py3d-0.0.87/
--rw-r--r--   0 runner    (1001) docker     (122)     2031 2023-05-15 14:09:37.648146 py3d-0.0.87/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)     1640 2023-05-15 14:09:26.000000 py3d-0.0.87/README.md
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-05-15 14:09:37.644146 py3d-0.0.87/py3d/
--rw-r--r--   0 runner    (1001) docker     (122)      178 2023-05-15 14:09:26.000000 py3d-0.0.87/py3d/__init__.py
--rw-r--r--   0 runner    (1001) docker     (122)    26933 2023-05-15 14:09:26.000000 py3d-0.0.87/py3d/core.py
--rw-r--r--   0 runner    (1001) docker     (122)    22184 2023-05-15 14:09:26.000000 py3d-0.0.87/py3d/viewer.html
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-05-15 14:09:37.648146 py3d-0.0.87/py3d.egg-info/
--rw-r--r--   0 runner    (1001) docker     (122)     2031 2023-05-15 14:09:37.000000 py3d-0.0.87/py3d.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)      204 2023-05-15 14:09:37.000000 py3d-0.0.87/py3d.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2023-05-15 14:09:37.000000 py3d-0.0.87/py3d.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (122)       26 2023-05-15 14:09:37.000000 py3d-0.0.87/py3d.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (122)        5 2023-05-15 14:09:37.000000 py3d-0.0.87/py3d.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (122)       38 2023-05-15 14:09:37.648146 py3d-0.0.87/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (122)     1457 2023-05-15 14:09:26.000000 py3d-0.0.87/setup.py
