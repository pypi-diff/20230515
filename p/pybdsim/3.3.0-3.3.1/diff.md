# Comparing `tmp/pybdsim-3.3.0.tar.gz` & `tmp/pybdsim-3.3.1.tar.gz`
...
### Comparing `pybdsim-3.3.0/docs/Makefile` & `pybdsim-3.3.1/docs/Makefile`
...
### Comparing `pybdsim-3.3.0/docs/source/figures/rebdsimFileHistograms.png` & `pybdsim-3.3.1/docs/source/figures/rebdsimFileHistograms.png`
...
### Comparing `pybdsim-3.3.0/src/pybdsim/Convert/_MadxTfs2GmadStrength.py` & `pybdsim-3.3.1/src/pybdsim/Convert/_MadxTfs2GmadStrength.py`
...
### Comparing `pybdsim-3.3.0/src/pybdsim.egg-info/SOURCES.txt` & `pybdsim-3.3.1/src/pybdsim.egg-info/SOURCES.txt`
...
### Comparing `pybdsim-3.3.0/tests/test_output/model-model/model_components.gmad` & `pybdsim-3.3.1/tests/test_output/model-model/model_components.gmad`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/test_output/model-model/model_sequence.gmad` & `pybdsim-3.3.1/tests/test_output/model-model/model_sequence.gmad`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/test_output2/atf2-nominal-twiss-v5.2/model_components.gmad` & `pybdsim-3.3.1/tests/test_output2/atf2-nominal-twiss-v5.2/model_components.gmad`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/test_output2/atf2-nominal-twiss-v5.2/model_sequence.gmad` & `pybdsim-3.3.1/tests/test_output2/atf2-nominal-twiss-v5.2/model_sequence.gmad`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/test_output2/model-model/model_components.gmad` & `pybdsim-3.3.1/tests/test_output2/model-model/model_components.gmad`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/test_output2/model-model/model_sequence.gmad` & `pybdsim-3.3.1/tests/test_output2/model-model/model_sequence.gmad`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/tests/pybdsim_test_utils.py` & `pybdsim-3.3.1/tests/tests/pybdsim_test_utils.py`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/tests/test_MadxTfs2Gmad.py` & `pybdsim-3.3.1/tests/tests/test_MadxTfs2Gmad.py`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/tests/testratio.py` & `pybdsim-3.3.1/tests/tests/testratio.py`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/tests/write_test_outputs.py` & `pybdsim-3.3.1/tests/tests/write_test_outputs.py`

 * *Files identical despite different names*

### Comparing `pybdsim-3.3.0/tests/unit/test_Builder.py` & `pybdsim-3.3.1/tests/unit/test_Builder.py`
