# Comparing `tmp/renku_lock-2.4.0rc2-py3-none-any.whl.zip` & `tmp/renku_lock-2.4.1rc1-py3-none-any.whl.zip`
...
## Comparing `renku_lock-2.4.0rc2.dist-info/METADATA` & `renku_lock-2.4.1rc1.dist-info/METADATA`
...
-Requires-Dist: ZEO (==5.4.0) ; python_full_version >= "2.7.9" and python_full_version < "3.0.0" or python_full_version >= "3.5.0"
